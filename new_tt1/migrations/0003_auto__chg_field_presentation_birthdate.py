...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Presentation.birthdate'
        db.alter_column(u'new_tt1_presentation', 'birthdate', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Presentation.birthdate'
        db.alter_column(u'new_tt1_presentation', 'birthdate', self.gf('django.db.models.fields.DateTimeField')())
